...
private:
  ...
  void filter_boxes(const custom_msgs::PolygonArray&);            // filters boxes and saves in filtered_boxes_
  void road_markings_callback(const custom_msgs::RoadMarkings&);  // checks if boxes from filtered_boxes_ are on right
                                                                  // lane
  void obstacle_callback(const custom_msgs::PolygonArray&);
  ...
  bool is_obstacle_next_to_car(const custom_msgs::PolygonArray&);

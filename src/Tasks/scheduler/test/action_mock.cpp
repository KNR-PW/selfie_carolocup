...
class ActionMock
{
    ros::NodeHandle nh_;
    ros::NodeHandle pnh_;
    actionlib::SimpleActionServer <custom_msgs::parkAction> park_action_;
    actionlib::SimpleActionServer <custom_msgs::drivingAction> drive_action_;
    actionlib::SimpleActionServer <custom_msgs::startingAction> starting_action_;
    actionlib::SimpleActionServer <custom_msgs::searchAction> search_action_;
    actionlib::SimpleActionServer <custom_msgs::intersectionAction> intersection_action_;
...
public:
    ...
    void starting_action_goalCB(const custom_msgs::startingGoalConstPtr &goal)
    {
        ...
        {
            starting_action_.setSucceeded([](bool result)
            {
                custom_msgs::startingResult starting_result;
                starting_result.drive_mode = result;
    ...
    void drive_action_goalCB(const custom_msgs::drivingGoalConstPtr &goal)
    {
        ...
        {
            drive_action_.setSucceeded([](bool result)
            {
                custom_msgs::drivingResult drive_result;
                drive_result.event = result;
                return drive_result;
            }
            (true));
        }
    ...
    void park_action_goalCB(const custom_msgs::parkGoalConstPtr &goal)
    {
        ...
        {
            park_action_.setSucceeded([](bool result)
            {
                custom_msgs::parkResult park_result;
                park_result.done = result;
                return park_result;
            }
            (true));
        }
    ...
    void search_action_goalCB(const custom_msgs::searchGoalConstPtr &goal)
    {
        ROS_INFO("Search goal is %f", goal->min_spot_lenght);
        custom_msgs::searchFeedback search_feedback;
    ...
    void intersection_action_goalCB(const custom_msgs::intersectionGoalConstPtr &goal)
    {
        ROS_INFO("Intersection goal is empty");
        waitGivenTime(action_time_);
        if (intersection_action_.isActive())
        {
            intersection_action_.setSucceeded([](bool result)
            {
                custom_msgs::intersectionResult intersection_result;
                intersection_result.done = result;

...
ParkClient::ParkClient(std::string name, const ros::NodeHandle& pnh) : ac_(name, true), pnh_(pnh), result_(0)
{
...
void ParkClient::setGoal(boost::any goal)
{
  ...
  ac_.sendGoal(goal_, boost::bind(&ParkClient::doneCb, this, _1, _2), boost::bind(&ParkClient::activeCb, this));
...
void ParkClient::doneCb(const actionlib::SimpleClientGoalState& state, const custom_msgs::parkResultConstPtr& result)
{

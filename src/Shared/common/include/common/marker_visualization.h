...
void visualizeBox2D(float &min_x, float &max_x, float &min_y, float &max_y, const ros::Publisher &pub,
                    const std::string &name, float r = 0.4, float g = 0.3, float b = 0, int lifetime = 2,
                    const std::string &frame_id = "base_link");

void visualizeBox2D(const custom_msgs::Box2D &box, const ros::Publisher &pub, const std::string &name, float r = 0.4,
                    float g = 0.3, float b = 0, int lifetime = 2, const std::string &frame_id = "base_link");

void visualizeBoxes2D(const std::vector<custom_msgs::Box2D> &boxes, const ros::Publisher &pub, const std::string &name,
                      float r = 0.4, float g = 0.3, float b = 0, int lifetime = 2,
                      const std::string &frame_id = "base_link");
...
void visualizeBoxes2D(const custom_msgs::Box2DArray &boxes, const ros::Publisher &pub, const std::string &name,
                      float r = 0.4, float g = 0.3, float b = 0, int lifetime = 2,
                      const std::string &frame_id = "base_link");

void visualizeEmpty(const ros::Publisher &pub, const std::string &name,
                    float r = 0.4, float g = 0.3, float b = 0, int lifetime = 2,
                    const std::string &frame_id = "base_link");
}  // namespace selfie
